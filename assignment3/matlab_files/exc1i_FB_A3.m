% ========== PART 1(i): PARAMETER UNCERTAINTY - FEEDBACK ONLY ==========
...
for case_idx = 1:size(uncertainty_cases, 1)
    ...
    % ========== SIMULATION WITH MODEL MISMATCH - FEEDBACK ONLY ==========
    x0 = [0; 0; 0; 0];
    x = x0;
    ...
    for k = 1:length(t)
        ...
        % FEEDBACK ONLY - no feedforward component
        u_fb = -K * (x - x_ref_nominal);
        u_total = u_fb;  % ONLY feedback, no u_inv
...
sgtitle('Feedback Only: Robustness to Parameter Uncertainty');
